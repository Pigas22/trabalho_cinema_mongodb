...
public class InserirEndereco extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Digite a rua");

        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Digite a cidade");
        ...
        jLabel6.setText("Digite o bairro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InserirEndereco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InserirEndereco().setVisible(true);
            }
        });
    }
